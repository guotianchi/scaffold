...
1. **Update check**: Run `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/check-update.mjs"`. Exit 0 → continue. Exit 1 → non-blocking upgrade reminder. Exit 2 → skip.
...
After confirmation:
```bash
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state set <change-dir> dp_0_decisions "<summary>"
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state set <change-dir> dp_0_result confirmed
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state set <change-dir> dp_0_confirmed true
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state set <change-dir> dp_0_timestamp $(date -u +%Y-%m-%dT%H:%M:%SZ)
```
...
If workflow is `auto`/`null`/unset: run `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/infer-workflow.mjs" <change-dir>`. Inference: **hotfix** (≤2 tasks, ≤2 files, no schema/API/new modules), **tweak** (≤4 tasks, config/doc only), **full** (anything larger). Persist with `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state set <dir> workflow <mode>`.
...
Guard: `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/guard/guard.mjs" check <dir> exploring specifying --json` → fail = BLOCK. User knows what they want, artifacts missing/incomplete.
...
```bash
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" handoff create <change-dir> \
  --type prototype --objective "<confirmed objective>" \
  --expected-output "<expected evidence>" --acceptance "<completion criterion>"
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" isolate <change-dir> prototype-<handoff-id>
```
...
Post-transition: 💡 `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" inject <change-dir>` to update phase-guard artifacts.
