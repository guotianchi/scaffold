...
```bash
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state set <change-dir> dp_3_result "approved: <summary>"
node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state set <change-dir> dp_3_timestamp $(date -u +%Y-%m-%dT%H:%M:%SZ)
```
...
Run `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state init <change-dir>` to create `.spec-superflow.yaml` with hashes.

For hotfix, after writing the minimal contract, run `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state init <change-dir>` or `node "/Users/guotianchi/Documents/project/springboot-scaffold/.cursor/spec-superflow/scripts/spec-superflow.mjs" state rebuild <change-dir>` so `contract_hash` is recorded. DP-3 remains mandatory before build.
